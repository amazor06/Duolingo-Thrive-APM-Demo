...
export default function DeepDiveHome({ onStart }) {
  return (
    <div className="stack">
      ...
      <Card>
        <div className="sectionTitle">Your metrics (mock)</div>
        <div className="divider" />
        <div className="metricGrid">
          <div className="metric">
            <div className="metricLabel">D7 retention</div>
            <div className="metricValue">↑ 6%</div>
          </div>
          <div className="metric">
            <div className="metricLabel">Return rate</div>
            <div className="metricValue">↑ 10%</div>
          </div>
          <div className="metric">
            <div className="metricLabel">TSLW</div>
            <div className="metricValue">+1.4m</div>
          </div>
          <div className="metric">
            <div className="metricLabel">Comprehension</div>
            <div className="metricValue">A-</div>
          </div>
        </div>
      </Card>
    </div>
